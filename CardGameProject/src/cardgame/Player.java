...
public class Player extends Thread implements Runnable, Loggable {		
	 ...
	 //Override "loggable" methods:
	 @Override
	 public String getLogFileName() {
		 return "player" + playerId + "_output.txt";
	 }
	 @Override
	 public String getLogInitialState() {
		 return "player " + playerId + " initial hand: " + LogWriter.handToString(this);
	  }
	 @Override
	 public String getLogFinalState() {
		 return "player " + playerId + " final hand: " + LogWriter.handToString(this);
	 }	 
